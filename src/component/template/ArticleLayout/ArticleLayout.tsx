...
export const ArticleLayout: React.FC<BlogPost> = ({ data }) => {
   ...
   return (
      <BaseLayout
         ...
         image={`https://res.cloudinary.com/dff7r0iah/image/upload/l_text:Sawarabi%20Gothic_50_bold:これはOGPテキストです！,co_rgb:333,w_500,c_fit/v12345678/v1657348914/OGB-blog_nvuwol.png`}
      >
         <ContentContainer>
            <p
               css={css`
